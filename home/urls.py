...
urlpatterns = [
  ...
  # Applications
  path('program/list/', views.proker_list, name="proker_list"),
  path('lapkeuangan/jurnal-new/', views.jurnal_new, name="jurnal_new"),
  path('lapkeuangan/jurnal-view/', views.jurnal_view, name="jurnal_view"),
  path('lapkeuangan/labarugi-view/', views.labarugi_view, name="labarugi_view"),
  path('lapkeuangan/neraca-view/', views.neraca_view, name="neraca_view"),
  path('lapkeuangan/unitreport-view/', views.unitreport_view, name="unitreport_view"),
