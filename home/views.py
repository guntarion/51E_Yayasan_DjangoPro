...
def default(request):
  ...
  logger( f'[{__name__}->{func_name}(), L:{currentframe().f_lineno}] ' + '----------------------------' )
...
def proker_list(request):
  ...
  return render(request, 'yayasan/program_kerja_list.html', context)
...
def jurnal_new(request):
  ...
  return render(request, 'yayasan/jurnal_new.html', context)
...
def jurnal_view(request):
  ...
  return render(request, 'yayasan/jurnal_view.html', context)
...
def labarugi_view(request):
  ...
  return render(request, 'yayasan/labarugi_view.html', context)
...
def neraca_view(request):
  ...
  return render(request, 'yayasan/neraca_view.html', context)
...
def unitreport_view(request):
  ...
  return render(request, 'yayasan/unitreport_view.html', context)
